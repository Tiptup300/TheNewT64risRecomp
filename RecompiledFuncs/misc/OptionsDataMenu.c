...
RECOMP_FUNC void OptionsDataMenu_CursorPrevSlot(uint8_t* rdram, recomp_context* ctx) {
...
RECOMP_FUNC void OptionsDataMenu_CursorNextSlot(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
RECOMP_FUNC void OptionsDataMenu_Process(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
...
L_8004C344:
    ...
    OptionsDataMenu_CursorNextSlot(rdram, ctx);
        goto after_54;
    // 0x8004C598: nop
...
L_8004C59C:
    ...
    OptionsDataMenu_CursorPrevSlot(rdram, ctx);
        goto after_55;
    // 0x8004C5D8: nop
